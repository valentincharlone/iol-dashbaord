  ...
  return (
    <div>
      ...
      <svg viewBox={`0 0 ${W} ${H}`} style={{ width: "100%", overflow: "visible" }}>
        ...
        {gridLines.map((g, i) => (
          <g key={i}>
            ...
            <text x={PX - 8} y={g.y + 4} textAnchor="end"
              fill="#A0A3BD" fontSize="8" fontFamily={font}>
              {g.label}
            </text>
          </g>
        ))}
        ...
        <rect x={last.x - 34} y={last.y - 26} width={68} height={17} rx="4" fill="#EEF2FF" />
        <text x={last.x} y={last.y - 14} textAnchor="middle"
          fill="#4338CA" fontSize="9" fontWeight="600" fontFamily={font}>
